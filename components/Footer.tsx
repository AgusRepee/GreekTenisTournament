...
import { getClubAddressLinesFromSettings, useSiteSettings } from '../src/lib/siteSettings';
...
export const Footer: React.FC<FooterProps> = ({ setScreen }) => {
  ...
  }, [settings.club.whatsappDigits, settings.club.instagramHandle]);
      ...
      <div className="max-w-[1440px] mx-auto py-12 md:py-14 px-4 md:px-8 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 text-center md:text-left">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-[11px] font-bold text-[#111318] dark:text-white uppercase tracking-[0.14em]">Redes</h3>
